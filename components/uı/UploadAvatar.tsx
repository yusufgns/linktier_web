...
const ProfilePicture: React.FC<ProfilePictureProps> = () => {
  ...
  const renderPreviewImage = () => {
    if (previewImage) {
      return <Image src={previewImage} alt="Preview" style={{ borderRadius: '50%', width: '70px', height: '70px' }} width={150} height={150} />
    }
  ...
  return (
    ...
    >
        ...
        >
                ...
                <p className={`text-[10px] text-white font-bold h-[70px] w-[70px] rounded-[50%] flex items-center justify-center 
