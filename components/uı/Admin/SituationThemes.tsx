...
const Themes: React.FC<themesI> = ({onClick, over_c, completing_c, text_c}: themesI) => {
    const style1 = over_c ? { backgroundColor: over_c } : {};
    const style2 = completing_c ? { backgroundColor: completing_c } : {};
    const style3 = text_c ? { backgroundColor: text_c } : {};
    ...
    return (
        ...
        '>
            ...
            <div className='w-[60px] bg-[#033e59] h-full' style={style3}></div>
        </div>
    )
}
